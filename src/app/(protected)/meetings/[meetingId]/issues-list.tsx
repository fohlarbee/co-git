    ...
    <>
        <div className="p-8">
                <div className='mx-auto flex max-w-2xl items-center justify-between gap-x-8 border-b pb-6 lg:mx-0 lg:max-w-none'>
                        <div className='flex items-center gap-x-6'>
                            ...
                            <h1>
                                ...
                                <div className="mt-1 text-base font-semibold leading-6 text-gray-800">
                                    {meeting.name}
                                </div>  
                            </h1>
                ...
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                        {meeting.issues.map((issue, index)=> <IssueCard key={index} issue={issue}/>)}
                </div> 
    ...
    return(
        <>
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle className='text-xl mt-3'>
                            {issue.gist}
                        </DialogTitle>
                        <DialogDescription>
